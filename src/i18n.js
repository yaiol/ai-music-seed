...
const TRANSLATIONS = {
  en: {
    ...
    lblSeedName:                            "Output name",
    plhSeedName:                            "(auto)",
    hntSeedName:                            "Tokens replaced at render: {chords} (the chord names), {style}, {bpm}, {loops}. Blank uses {chords}-{style}-{bpm}.",
  ...
  fr: {
    ...
    lblSeedName:                            "Nom de sortie",
    plhSeedName:                            "(auto)",
    hntSeedName:                            "Jetons remplacés au rendu : {chords} (noms d'accords), {style}, {bpm}, {loops}. Vide utilise {chords}-{style}-{bpm}.",
  ...
  de: {
    ...
    optSeedFormatWav:                       "WAV",
    lblSeedMp3Bitrate:                      "MP3-Bitrate",
    lblSeedName:                            "Ausgabename",
    plhSeedName:                            "(auto)",
    hntSeedName:                            "Beim Rendern ersetzte Tokens: {chords} (Akkordnamen), {style}, {bpm}, {loops}. Leer verwendet {chords}-{style}-{bpm}.",
  ...
  es: {
    ...
    lblSeedName:                            "Nombre de salida",
    plhSeedName:                            "(automático)",
    hntSeedName:                            "Tokens reemplazados al renderizar: {chords} (nombres de acordes), {style}, {bpm}, {loops}. En blanco usa {chords}-{style}-{bpm}.",
  ...
  pt_BR: {
    ...
    optSeedFormatWav:                       "WAV",
    lblSeedMp3Bitrate:                      "Bitrate MP3",
    lblSeedName:                            "Nome de saída",
    plhSeedName:                            "(automático)",
    hntSeedName:                            "Tokens substituídos na renderização: {chords} (nomes dos acordes), {style}, {bpm}, {loops}. Em branco usa {chords}-{style}-{bpm}.",
  ...
  it: {
    ...
    optSeedFormatWav:                       "WAV",
    lblSeedMp3Bitrate:                      "Bitrate MP3",
    lblSeedName:                            "Nome output",
    plhSeedName:                            "(auto)",
    hntSeedName:                            "Token sostituiti al rendering: {chords} (nomi degli accordi), {style}, {bpm}, {loops}. Vuoto usa {chords}-{style}-{bpm}.",
  ...
  nl: {
    ...
    optSeedFormatWav:                       "WAV",
    lblSeedMp3Bitrate:                      "MP3-bitrate",
    lblSeedName:                            "Uitvoernaam",
    plhSeedName:                            "(auto)",
    hntSeedName:                            "Tokens vervangen bij renderen: {chords} (akkoordnamen), {style}, {bpm}, {loops}. Leeg gebruikt {chords}-{style}-{bpm}.",
  ...
  ru: {
    ...
    lblSeedName:                            "Имя вывода",
    plhSeedName:                            "(авто)",
    hntSeedName:                            "Токены, заменяемые при рендеринге: {chords} (названия аккордов), {style}, {bpm}, {loops}. Пустое использует {chords}-{style}-{bpm}.",
  ...
  uk: {
    ...
    lblSeedName:                            "Назва виводу",
    plhSeedName:                            "(авто)",
    hntSeedName:                            "Токени, що замінюються при рендерингу: {chords} (назви акордів), {style}, {bpm}, {loops}. Порожнє використовує {chords}-{style}-{bpm}.",
  ...
  pl: {
    ...
    optSeedFormatWav:                       "WAV",
    lblSeedMp3Bitrate:                      "Bitrate MP3",
    lblSeedName:                            "Nazwa wyjściowa",
    plhSeedName:                            "(automatycznie)",
    hntSeedName:                            "Tokeny zastępowane podczas renderowania: {chords} (nazwy akordów), {style}, {bpm}, {loops}. Puste używa {chords}-{style}-{bpm}.",
  ...
  ro: {
    ...
    optSeedFormatWav:                       "WAV",
    lblSeedMp3Bitrate:                      "Bitrate MP3",
    lblSeedName:                            "Nume ieșire",
    plhSeedName:                            "(auto)",
    hntSeedName:                            "Tokenuri înlocuite la randare: {chords} (numele acordurilor), {style}, {bpm}, {loops}. Gol folosește {chords}-{style}-{bpm}.",
  ...
  sv: {
    ...
    optSeedFormatWav:                       "WAV",
    lblSeedMp3Bitrate:                      "MP3-bitrate",
    lblSeedName:                            "Utmatningsnamn",
    plhSeedName:                            "(auto)",
    hntSeedName:                            "Tokens som ersätts vid rendering: {chords} (ackordnamnen), {style}, {bpm}, {loops}. Tomt använder {chords}-{style}-{bpm}.",
  ...
  nb: {
    ...
    optSeedFormatWav:                       "WAV",
    lblSeedMp3Bitrate:                      "MP3-bitrate",
    lblSeedName:                            "Utfilnavn",
    plhSeedName:                            "(auto)",
    hntSeedName:                            "Tokens erstattet ved rendering: {chords} (akkordnavnene), {style}, {bpm}, {loops}. Tomt bruker {chords}-{style}-{bpm}.",
  ...
  tr: {
    ...
    lblSeedName:                            "Çıkış adı",
    plhSeedName:                            "(otomatik)",
    hntSeedName:                            "Oluşturmada değiştirilen belirteçler: {chords} (akor adları), {style}, {bpm}, {loops}. Boş bırakılırsa {chords}-{style}-{bpm} kullanılır.",
  ...
  hr: {
    ...
    optSeedFormatWav:                       "WAV",
    lblSeedMp3Bitrate:                      "MP3 bitrate",
    lblSeedName:                            "Izlazni naziv",
    plhSeedName:                            "(automatski)",
    hntSeedName:                            "Tokeni zamijenjeni pri renderiranju: {chords} (nazivi akorda), {style}, {bpm}, {loops}. Prazno koristi {chords}-{style}-{bpm}.",
  ...
  el: {
    ...
    optSeedFormatWav:                       "WAV",
    lblSeedMp3Bitrate:                      "Bitrate MP3",
    lblSeedName:                            "Όνομα εξόδου",
    plhSeedName:                            "(αυτόματο)",
    hntSeedName:                            "Διακριτικά που αντικαθίστανται κατά την απόδοση: {chords} (ονόματα συγχορδιών), {style}, {bpm}, {loops}. Το κενό χρησιμοποιεί {chords}-{style}-{bpm}.",
  ...
  he: {
    ...
    lblSeedName:                            "שם פלט",
    plhSeedName:                            "(אוטומטי)",
    hntSeedName:                            "אסימונים מוחלפים ברינדור: {chords} (שמות האקורדים), {style}, {bpm}, {loops}. ריק משתמש ב-{chords}-{style}-{bpm}.",
  ...
  ar: {
    ...
    lblSeedName:                            "اسم الإخراج",
    plhSeedName:                            "(تلقائي)",
    hntSeedName:                            "الرموز المستبدلة عند العرض: {chords} (أسماء الكوردات), {style}, {bpm}, {loops}. الفراغ يستخدم {chords}-{style}-{bpm}.",
  ...
  fa: {
    ...
    lblSeedName:                            "نام خروجی",
    plhSeedName:                            "(خودکار)",
    hntSeedName:                            "توکن‌های جایگزین شده هنگام رندر: {chords} (نام آکوردها), {style}, {bpm}, {loops}. خالی از {chords}-{style}-{bpm} استفاده می‌کند.",
  ...
  zh_CN: {
    ...
    lblSeedName:                            "输出名称",
    plhSeedName:                            "(自动)",
    hntSeedName:                            "渲染时替换的令牌：{chords}（和弦名称）、{style}、{bpm}、{loops}。留空则使用 {chords}-{style}-{bpm}。",
    btnSeedRender:                          "渲染种子",
  ...
  zh_TW: {
    ...
    lblSeedName:                            "輸出名稱",
    plhSeedName:                            "(自動)",
    hntSeedName:                            "渲染時替換的令牌：{chords}（和弦名稱）、{style}、{bpm}、{loops}。空白時使用 {chords}-{style}-{bpm}。",
    btnSeedRender:                          "渲染種子",
  ...
  ja: {
    ...
    lblSeedName:                            "出力名",
    plhSeedName:                            "(自動)",
    hntSeedName:                            "レンダリング時に置き換えられるトークン：{chords}（コード名）、{style}、{bpm}、{loops}。空白の場合は {chords}-{style}-{bpm} を使用します。",
  ...
  ko: {
    ...
    lblSeedName:                            "출력 이름",
    plhSeedName:                            "(자동)",
    hntSeedName:                            "렌더링 시 대체되는 토큰: {chords} (코드 이름), {style}, {bpm}, {loops}. 비워두면 {chords}-{style}-{bpm}을 사용합니다.",
  ...
  vi: {
    ...
    lblSeedName:                            "Tên đầu ra",
    plhSeedName:                            "(tự động)",
    hntSeedName:                            "Các token được thay thế khi render: {chords} (tên hợp âm), {style}, {bpm}, {loops}. Để trống sẽ dùng {chords}-{style}-{bpm}.",
  ...
  th: {
    ...
    lblSeedName:                            "ชื่อเอาต์พุต",
    plhSeedName:                            "(อัตโนมัติ)",
    hntSeedName:                            "โทเค็นที่ถูกแทนที่เมื่อเรนเดอร์: {chords} (ชื่อคอร์ด), {style}, {bpm}, {loops} หากเว้นว่างจะใช้ {chords}-{style}-{bpm}",
  ...
  id: {
    ...
    optSeedFormatWav:                       "WAV",
    lblSeedMp3Bitrate:                      "Bitrate MP3",
    lblSeedName:                            "Nama keluaran",
    plhSeedName:                            "(otomatis)",
    hntSeedName:                            "Token yang diganti saat render: {chords} (nama akor), {style}, {bpm}, {loops}. Kosong menggunakan {chords}-{style}-{bpm}.",
    btnSeedRender:                          "Render seed",
  ...
  ca: {
    ...
    optSeedFormatWav:                       "WAV",
    lblSeedMp3Bitrate:                      "Bitrate MP3",
    lblSeedName:                            "Nom de sortida",
    plhSeedName:                            "(automàtic)",
    hntSeedName:                            "Tokens substituïts en renderitzar: {chords} (noms dels acords), {style}, {bpm}, {loops}. En blanc utilitza {chords}-{style}-{bpm}.",
  ...
  cs: {
    ...
    optSeedFormatWav:                       "WAV",
    lblSeedMp3Bitrate:                      "MP3 bitrate",
    lblSeedName:                            "Název výstupu",
    plhSeedName:                            "(automaticky)",
    hntSeedName:                            "Tokeny nahrazené při vykreslování: {chords} (názvy akordů), {style}, {bpm}, {loops}. Prázdné používá {chords}-{style}-{bpm}.",
  ...
  da: {
    ...
    optSeedFormatWav:                       "WAV",
    lblSeedMp3Bitrate:                      "MP3-bitrate",
    lblSeedName:                            "Outputnavn",
    plhSeedName:                            "(automatisk)",
    hntSeedName:                            "Tokens erstattet ved rendering: {chords} (akkordnavne), {style}, {bpm}, {loops}. Tomt bruger {chords}-{style}-{bpm}.",
    btnSeedRender:                          "Render seed",
    ...
    lblSeedName:                            "Tulosteen nimi",
    plhSeedName:                            "(automaattinen)",
    hntSeedName:                            "Renderöinnissä korvattavat tunnukset: {chords} (sointunimet), {style}, {bpm}, {loops}. Tyhjä käyttää {chords}-{style}-{bpm}.",
  ...
  ms: {
    ...
    lblSeedName:                            "Nama output",
    plhSeedName:                            "(automatik)",
    hntSeedName:                            "Token diganti semasa render: {chords} (nama kord), {style}, {bpm}, {loops}. Kosong menggunakan {chords}-{style}-{bpm}.",
  ...
  hy: {
    ...
    lblSeedName:                            "Ելքային անուն",
    plhSeedName:                            "(ավտոմատ)",
    hntSeedName:                            "Ռենդերինգի ժամանակ փոխարինվող թոքեններ՝ {chords} (ակորդների անուններ), {style}, {bpm}, {loops}։ Դատարկը օգտագործում է {chords}-{style}-{bpm}։",
  ...
  bg: {
    ...
    lblSeedName:                            "Име на изхода",
    plhSeedName:                            "(автоматично)",
    hntSeedName:                            "Токени, заменяни при рендиране: {chords} (имена на акорди), {style}, {bpm}, {loops}. Празното използва {chords}-{style}-{bpm}.",
  ...
  gl: {
    ...
    lblSeedName:                            "Nome de saída",
    plhSeedName:                            "(automático)",
    hntSeedName:                            "Tokens substituídos ao renderizar: {chords} (nomes dos acordes), {style}, {bpm}, {loops}. En branco usa {chords}-{style}-{bpm}.",
    btnSeedRender:                          "Renderizar semente",
  ...
  hu: {
    ...
    lblSeedName:                            "Kimeneti név",
    plhSeedName:                            "(automatikus)",
    hntSeedName:                            "Rendereléskor lecserélt tokenek: {chords} (akkordnevek), {style}, {bpm}, {loops}. Az üres {chords}-{style}-{bpm} értéket használ.",
  ...
  lt: {
    ...
    lblSeedName:                            "Išvesties pavadinimas",
    plhSeedName:                            "(automatinis)",
    hntSeedName:                            "Atvaizduojant pakeisti žetonai: {chords} (akordų pavadinimai), {style}, {bpm}, {loops}. Tuščia naudoja {chords}-{style}-{bpm}.",
  ...
  mk: {
    ...
    lblSeedName:                            "Име на излез",
    plhSeedName:                            "(автоматски)",
    hntSeedName:                            "Токени заменети при рендерирање: {chords} (имиња на акорди), {style}, {bpm}, {loops}. Празното користи {chords}-{style}-{bpm}.",
  ...
  sr: {
    ...
    optSeedFormatWav:                       "WAV",
    lblSeedMp3Bitrate:                      "MP3 битрејт",
    lblSeedName:                            "Излазно име",
    plhSeedName:                            "(аутоматски)",
    hntSeedName:                            "Токени замењени при рендеровању: {chords} (називи акорда), {style}, {bpm}, {loops}. Празан користи {chords}-{style}-{bpm}.",
  ...
  sk: {
    ...
    optSeedFormatWav:                       "WAV",
    lblSeedMp3Bitrate:                      "MP3 bitrate",
    lblSeedName:                            "Názov výstupu",
    plhSeedName:                            "(automaticky)",
    hntSeedName:                            "Tokeny nahradené pri vykresľovaní: {chords} (názvy akordov), {style}, {bpm}, {loops}. Prázdne používa {chords}-{style}-{bpm}.",
  ...
  sl: {
    ...
    lblSeedName:                            "Ime izhoda",
    plhSeedName:                            "(samodejno)",
    hntSeedName:                            "Žetoni, zamenjani ob upodabljanju: {chords} (imena akordov), {style}, {bpm}, {loops}. Prazno uporablja {chords}-{style}-{bpm}.",
  ...
  ta: {
    ...
    lblSeedName:                            "வெளியீட்டுப் பெயர்",
    plhSeedName:                            "(தானியங்கு)",
    hntSeedName:                            "ரெண்டரில் மாற்றப்படும் டோக்கன்கள்: {chords} (கோர் பெயர்கள்), {style}, {bpm}, {loops}. காலியாக இருந்தால் {chords}-{style}-{bpm} பயன்படுத்தப்படும்.",
  ...
  hi: {
    ...
    lblSeedName:                            "आउटपुट नाम",
    plhSeedName:                            "(स्वचालित)",
    hntSeedName:                            "रेंडर पर बदले गए टोकन: {chords} (कॉर्ड नाम), {style}, {bpm}, {loops}। खाली होने पर {chords}-{style}-{bpm} का उपयोग करता है।",
  ...
  bn: {
    ...
    lblSeedName:                            "আউটপুট নাম",
    plhSeedName:                            "(স্বয়ংক্রিয়)",
    hntSeedName:                            "রেন্ডারে প্রতিস্থাপিত টোকেন: {chords} (কর্ড নাম), {style}, {bpm}, {loops}। ফাঁকা থাকলে {chords}-{style}-{bpm} ব্যবহার করে।",
  ...
  ur: {
    ...
    lblSeedName:                            "آؤٹ پٹ نام",
    plhSeedName:                            "(خودکار)",
    hntSeedName:                            "ریندر پر تبدیل کیے گئے ٹوکن: {chords} (کورد کے نام), {style}, {bpm}, {loops}۔ خالی ہونے پر {chords}-{style}-{bpm} استعمال کرتا ہے۔",
  ...
  sw: {
    ...
    lblSeedName:                            "Jina la pato",
    plhSeedName:                            "(otomatiki)",
    hntSeedName:                            "Tokeni zilizobadilishwa wakati wa kutoa: {chords} (majina ya kodi), {style}, {bpm}, {loops}. Tupu hutumia {chords}-{style}-{bpm}.",
  ...
  pa: {
    ...
    lblSeedName:                            "ਆਉਟਪੁੱਟ ਨਾਮ",
    plhSeedName:                            "(ਆਟੋਮੈਟਿਕ)",
    hntSeedName:                            "ਰੈਂਡਰ 'ਤੇ ਬਦਲੇ ਗਏ ਟੋਕਨ: {chords} (ਕੋਰਡ ਦੇ ਨਾਮ), {style}, {bpm}, {loops}। ਖਾਲੀ ਹੋਣ 'ਤੇ {chords}-{style}-{bpm} ਵਰਤਦਾ ਹੈ।",
  ...
  ha: {
    ...
    optSeedFormatWav:                       "WAV",
    lblSeedMp3Bitrate:                      "MP3 bitrate",
    lblSeedName:                            "Sunan fitarwa",
    plhSeedName:                            "(atomatik)",
    hntSeedName:                            "Alamomin da aka maye gurbinsu a lokacin bayarwa: {chords} (sunayen kirtani), {style}, {bpm}, {loops}. Fanko yana amfani da {chords}-{style}-{bpm}.",
  ...
  yo: {
    ...
    lblSeedName:                            "Orukọ iṣelọpọ",
    plhSeedName:                            "(laifọwọyi)",
    hntSeedName:                            "Awọn ami ti a rọpo ni akoko fifunni: {chords} (awọn orukọ akọọlẹ), {style}, {bpm}, {loops}. Ofifo nlo {chords}-{style}-{bpm}.",
  ...
  te: {
    ...
    lblSeedName:                            "అవుట్‌పుట్ పేరు",
    plhSeedName:                            "(ఆటోమేటిక్)",
    hntSeedName:                            "రెండర్ వద్ద భర్తీ చేయబడిన టోకెన్‌లు: {chords} (కార్డ్ పేర్లు), {style}, {bpm}, {loops}. ఖాళీగా ఉంటే {chords}-{style}-{bpm} ఉపయోగిస్తుంది.",
  ...
  mr: {
    ...
    optSeedFormatWav:                       "WAV",
    lblSeedMp3Bitrate:                      "MP3 बिटरेट",
    lblSeedName:                            "आउटपुट नाव",
    plhSeedName:                            "(स्वयंचलित)",
    hntSeedName:                            "रेंडर करताना बदलले जाणारे टोकन: {chords} (कॉर्डची नावे), {style}, {bpm}, {loops}. रिकामे असल्यास {chords}-{style}-{bpm} वापरते.",
  ...
  tl: {
    ...
    optSeedFormatWav:                       "WAV",
    lblSeedMp3Bitrate:                      "MP3 bitrate",
    lblSeedName:                            "Pangalan ng output",
    plhSeedName:                            "(awtomatiko)",
    hntSeedName:                            "Mga token na papalitan sa pag-render: {chords} (mga pangalan ng chord), {style}, {bpm}, {loops}. Blangko ay gumagamit ng {chords}-{style}-{bpm}.",
